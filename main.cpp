...
int main(int argc, char *argv[])
{
    ...
    STE_TYPE type ;
    char str[64];
    fp = fopen("C:\\Users\\AB\\CLionProjects\\SymbolTabelProject\\t.txt","r");
    if(!fp) return 0;
    FILE *fout = fopen("C:\\Users\\AB\\CLionProjects\\SymbolTabelProject\\out.txt","w");   //set fout = stdout for screen output
    ...
    //STE_TYPE typeee = STE_INTEGER;
    //ST.Put_symbol("992001",typeee);
    //ST.Put_symbol("992001",typeee);
    //ST.PrintSymbolStats();
    //ST.Get_symbol("numFriends")->Name;
